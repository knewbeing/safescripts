// ==UserScript==
// @name        WEXI veck.io hack aimbot, ESP and Speed
// @namespace   https://wexi.qzz.io/
// @version     1.2
// @description veck.io Mod Menu - Aimbot, ESP, Kill all, God mode fly and more.
// @match       *://veck.io/*
// @run-at      document-idle
// @author      wexi
// @grant       none
// @license     MIT
// @downloadURL https://update.greasyfork.org/scripts/573903/WEXI%20veckio%20hack%20aimbot%2C%20ESP%20and%20Speed.user.js
// @updateURL https://update.greasyfork.org/scripts/573903/WEXI%20veckio%20hack%20aimbot%2C%20ESP%20and%20Speed.meta.js
// ==/UserScript==
...
(async function wxKeyGate() {
    ...
    overlay.innerHTML = `<div class="wx-key-box"><div class="wx-key-title">✦ WEXI Security</div><div class="wx-key-sub">Enter your daily access key to activate WEXI</div><input type="text" id="wx-key-input" placeholder="XXXX-XXXX-XXXX" spellcheck="false"><div class="wx-key-actions"><button id="btn-unlock">Unlock Client</button><a href="https://wexi.qzz.io/key" target="_blank" class="btn-get">Get Daily Key →</a></div><div id="wx-key-error"></div></div>`;
...
const applyStyles = () => {
    ...
    #wexi-wm {
        ...
        box-shadow: 0 6px 20px rgba(0,0,0,0.6), 0 0 15px rgba(0,229,255,0.1);
    }
    #wexi-wm::before {
        content: ''; width: 8px; height: 8px; border-radius: 50%;
        background: ${CY}; box-shadow: 0 0 10px rgba(0,229,255,0.6);
        animation: wxPulse 2s cubic-bezier(0.4, 0, 0.2, 1) infinite;
    }
...
del.onsuccess = () => console.log("UnityCache deleted");
    ...
    function addWatermark() {
        if (document.getElementById('wexi-wm')) return;
        const wm = document.createElement('div');
        wm.id = 'wexi-wm';
        wm.innerHTML = '<span>WEXI</span>';
...
(async () => {
    ...
    while(!document.head) await new Promise(r=>setTimeout(r,10));
