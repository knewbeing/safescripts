...
function main() {
    ...
    if (site === "spacetica.com" || site === "old.pahe.plus") {
        ...
        `);
               ...
               site === "softdevelopp.com" || site === "vpzserver.com" || site === "tophostdeal.com" || site === "evensuregd.com" || site === "bestensuree.com" || site === "hostzteam.com" ||
...
// Run when body is available
(() => {
    const runMain = () => {
        if (runMain.hasRun) return;
    ...
    if (!runMain.hasRun) {
        document.addEventListener('readystatechange', runMain);
    }
})();