// ==UserScript==
// @name YouTube℠ Ultimate Downloader v13.2 🚀 — All-in-One Media Suite 🌍🎥🎵 | Ad-Free + SponsorBlock 🛡
// @name:pt-BR YouTube℠ Ultimate Downloader v13.2 🚀 — Suíte de Mídia Tudo-em-Um 🌍🎥🎵 | Sem Anúncios + SponsorBlock 🛡
...
// @downloadURL https://update.greasyfork.org/scripts/34613/YouTube%E2%84%A0%20Ultimate%20Downloader%20v132%20%F0%9F%9A%80%20%E2%80%94%20All-in-One%20Media%20Suite%20%F0%9F%8C%8D%F0%9F%8E%A5%F0%9F%8E%B5%20%7C%20Ad-Free%20%2B%20SponsorBlock%20%F0%9F%9B%A1.user.js
// @updateURL https://update.greasyfork.org/scripts/34613/YouTube%E2%84%A0%20Ultimate%20Downloader%20v132%20%F0%9F%9A%80%20%E2%80%94%20All-in-One%20Media%20Suite%20%F0%9F%8C%8D%F0%9F%8E%A5%F0%9F%8E%B5%20%7C%20Ad-Free%20%2B%20SponsorBlock%20%F0%9F%9B%A1.meta.js
// ==/UserScript==
...
(function() {
  ...
  const MultiURL = [
    { name: "Download 1", baseURL: "//y2mate.stream/convert/?videoId=", useCoder: false, extra: "" },
    { name: "Download 2", baseURL: "//mpcourtefontaine.fr/#q=", useCoder: true, extra: "" },
    { name: "Download 3", baseURL: "//saveanyyoutube.com/watch?v=", useCoder: false, extra: "" },
    { name: "Download 4", baseURL: "//under250art.ca/convert/?id=", useCoder: false, extra: "" },
    { name: "Download 5", baseURL: "//www.climbtree70.fr/?id=", useCoder: false, extra: "" },
    { name: "Download 6", baseURL: "//yout.com/video/?url=", useCoder: true, extra: "" }
  ];
  ...
  const getVideoDom = () => {
    ...
    if (v && v !== video) {
      video = v;
      video.addEventListener("loadeddata", playAfterAd);
      video.addEventListener("canplay", playAfterAd);
    }
    return video;
  };
  
  const playAfterAd = async () => {
    if (!video || !video.paused || video.readyState < 3 || video.currentTime >= 5) return;
  ...
  function addFloatButton() {
    ...
    MultiURL.forEach(link => {
      ...
      btn.onclick = () => {
        const vid = getVideoID(location.href);
        if (!vid) return;
        const finalParam = link.useCoder ? decodeURIComponent(location.href) : vid;
