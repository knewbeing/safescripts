...
> 版本：**2017.7.21**　　发现时间：**2026-05-18**　　来源：[langren1353/GM_script](https://github.com/langren1353/GM_script) <Badge type="tip" text="GitHub" />

## 功能介绍

本脚本会在各大搜索引擎（如百度、谷歌、必应等）的搜索结果前自动添加序号，方便用户查看和区分每条结果的位置。无需手动操作，序号会自动显示在每条搜索结果前。适用于多种主流搜索网站。
...
2. 在搜索结果页面，每条结果前会自动显示序号。
3. 无需额外设置，序号自动添加，无需手动操作。
