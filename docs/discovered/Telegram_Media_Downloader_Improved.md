...
`下载工具`  `Telegram`  `媒体保存`  `图片视频下载`  `私密频道`
...
> 版本：**1.4**　　发现时间：**2026-05-11**　　来源：[GreasyFork](https://greasyfork.org/scripts/525471-telegram-media-downloader-improved) <Badge type="tip" text="GreasyFork" />　　安装量：**27,425**　　评分：👍7 / 👎4

## 功能介绍

本脚本让你可以在Telegram网页版中下载原本被禁止下载的图片、视频、GIF和语音消息，尤其适用于私密频道。即使频道限制了保存内容，也能一键保存所需媒体文件。
...
2. 进入包含图片、视频或语音的频道或聊天。
3. 在消息旁会出现下载按钮，点击即可保存媒体文件。
