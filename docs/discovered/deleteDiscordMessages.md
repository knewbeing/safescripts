...
> 版本：**5.2.6**　　发现时间：**2026-04-27**　　来源：[victornpb/undiscord](https://github.com/victornpb/undiscord) <Badge type="tip" text="GitHub" />
...
1. 1. 安装脚本后，打开 Discord 网页版。
2. 2. 进入你想要清理的频道或私信页面。
3. 3. 页面会出现 Undiscord 工具窗口，按提示操作即可批量删除消息。
