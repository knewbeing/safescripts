...
> 版本：**5.2.6**　　发现时间：**2026-06-08**　　来源：[GreasyFork](https://greasyfork.org/scripts/406540-undiscord) <Badge type="tip" text="GreasyFork" />　　安装量：**563,316**　　评分：👍51 / 👎8

## 功能介绍

该脚本可以批量删除 Discord 频道或私聊中的所有消息，帮助用户快速清理聊天记录。操作简单，无需手动逐条删除。
