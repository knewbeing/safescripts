...
> 版本：**5.2.6**　　发现时间：**2026-06-01**　　来源：[victornpb/undiscord](https://github.com/victornpb/undiscord) <Badge type="tip" text="GitHub" />

## 功能介绍

此脚本可以批量删除你在 Discord 频道或私信中的所有消息，帮助你快速清理聊天记录。操作简单，无需复杂设置。
